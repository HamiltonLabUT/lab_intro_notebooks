...
def viterbi(input_mlf, word_dictionary, output_mlf, phoneset, hmmdir, htk_path) :
    os.system('/usr/local/bin/HVite -T 1 -a -m -I ' + input_mlf + ' -H ' + hmmdir + '/macros -H ' + hmmdir + '/hmmdefs  -S ./tmp/test.scp -i ' + output_mlf + ' -p 0.0 -s 5.0 ' + word_dictionary + ' ' + phoneset + ' > ./tmp/aligned.results')
    # GK edited this Jan 25 2019 from his laptop.
